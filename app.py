...
def index():
    ...
    if request.method == "POST":
        ...
        db.execute('insert into log_date (entry_date) values (:database_date)', {'database_date' : database_date})
        db.commit()
...
def food():
    ...
    if request.method == 'POST':
        ...
        values (:name, :protein, :carbohydrates, :fat, :calories)''', {'name': name, 'protein': protein, 'carbohydrates': carbohydrates, 'fat': fat, 'calories' : calories})
        db.commit()     
